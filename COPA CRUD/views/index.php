...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="menu">
            ...
            <a href="index.php?action=criar">SOU FAN</a>
            <a href="index.php?action=chaveamento">GRUPOS</a>
            <a href="index.php?action=oitavas">OITAVAS</a>
            <a href="#">INGRESSOS</a>
        </div>
    </nav>
        ...
        <div class="grupos-grid">
            ...
            <div class="grupo-bloco">
                ...
                <table>
                    ...
                    <tbody>
                        <?php foreach ($porGrupo[$grupo] as $i => $row): ?>
                        <tr>
                            <td style="font-weight: bold; color: var(--text-muted);"><?= $i + 1 ?>º</td>
                            <td style="font-weight: bold;"><?= htmlspecialchars($row['nome']) ?></td>
                            <td style="text-align: center;"><?= htmlspecialchars($row['titulos']) ?> 🏆</td>
                            <td>
